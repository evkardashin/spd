(function () {
  ...
  try {
    ...
    function play() {
      ...
      gsap.set(cards, { opacity: 0, y: 34, scale: 0.9, rotate: -3 });
      ...
      // (в исходном дизайне у него нет border-radius, т.е. финал — прямые углы).
      ...
      rows.forEach(function (row, i) {
        ...
        tl.to(row, {
          opacity: 1, y: 0, scale: 1, rotate: 0, duration: 0.8, stagger: 0.08, ease: 'back.out(1.8)'
        }, position);
