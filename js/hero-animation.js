    ...
    mm.add(
      ...
      function (context) {
        ...
        if (isMobile) {
          ...
          // Начинаем правую картинку примерно вдвое раньше: раньше её старт
          // зависел от конца длинного stagger логотипов и приходился примерно
          // на 1.51 с. Длительность и характер самой анимации не меняем.
          tl.to(desktopImg, { opacity: 1, y: 0, scale: 1, rotate: 0, duration: 1, ease: 'back.out(1.6)' }, 0.35);
